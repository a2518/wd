...
newShareCodes = [{"inviteCode":"YEpuMqixYPU"},{"inviteCode":"YEpuMqixYPxJrA"},{"inviteCode":"eU9YaOzjY_8upWrVn3EThw"},{"inviteCode":"eU9YaOqxZfgvo2-Hy3QbhQ"}] //这里修改你的邀请码
if ($.isNode()) {
...
function helpFriend(helpInfo) {
  return new Promise((resolve) => {
    $.get(taskUrl("cash_mob_assist", {...helpInfo,"source":3,"shareDate":"IRs1bey0ZPU"}), (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
